...
export const DesarrolloGlobal = () => {
  ...
  // gsap.from(ImagenDerechaElement.current, { x: -500, opacity: 0 });
  useEffect(() => {
  ...
  return (
    <>
      ...
      <br />
      <div className="px-4  mx-auto max-w-[95%] xl:max-w-[75%]">
        <div>
          <p>
            aaaa Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus recusandae porro deserunt tenetur nihil. Quod facilis
            alias totam officia quo? Debitis accusantium similique blanditiis corporis culpa ratione perferendis, nobis nihil.
          </p>
          <br />
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus recusandae porro deserunt tenetur nihil. Quod facilis alias
            totam officia quo? Debitis accusantium similique blanditiis corporis culpa ratione perferendis, nobis nihil.
          </p>
          <br />
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus recusandae porro deserunt tenetur nihil. Quod facilis alias
